(function () {
    ...
    function renderReport(data) {
        $('#report-period').text(
            'As of: ' + formatDate(data.asOfDate) + ' — ' + data.lineCount + ' stack line(s)'
        );
        ...
        data.lines.forEach(function (line) {
            $tbody.append(
                ...
                '<td class="text-end">' + formatQty(line.cartons, true) + '</td>' +
                '<td class="text-end">' + formatQty(line.quantity, false) + '</td>' +
        ...
        $('#report-total-cartons').text(formatQty(data.totalCartons, true));
        $('#report-total-stock').text(formatQty(data.totalStock, false));
    ...
    function loadReport() {
        ...
        $.getJSON('/api/inventory-reports/stack-wise-stock', params)
            .done(renderReport)
            .fail(function (xhr) {
