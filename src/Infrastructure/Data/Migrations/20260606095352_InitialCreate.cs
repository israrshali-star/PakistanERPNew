        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScenarioType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScenarioTypes", x => x.ScenarioId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubTypeCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubAccountTypes", x => x.SubTypeId);
                    table.ForeignKey(
                        name: "FK_SubAccountTypes_AccountTypes_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FbrPostUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AccountNumber = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChartOfAccounts_AccountTypes_TypeId",
                        column: x => x.TypeId,
                        principalTable: "AccountTypes",
                        principalColumn: "TypeId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChartOfAccounts_SubAccountTypes_SubTypeId",
                        column: x => x.SubTypeId,
                        principalTable: "SubAccountTypes",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    ScenarioTypeScenarioId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Customers_ScenarioTypes_ScenarioTypeScenarioId",
                        column: x => x.ScenarioTypeScenarioId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SalesTaxRate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    UnregisteredSalesTaxRate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VendorCode = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    ...
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NTN = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DefaultSalesTaxRate = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 18m),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StackNo = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FurtherTax = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    FED = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    ExtraTax = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    WithholdingTax = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    ...
                    ScenarioTypeScenarioId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SalesInvoices_ScenarioTypes_ScenarioTypeScenarioId",
                        column: x => x.ScenarioTypeScenarioId,
                        principalTable: "ScenarioTypes",
                        principalColumn: "ScenarioId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCartons = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionType = table.Column<int>(type: "int", nullable: false),
                    StackNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Cartons = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cartons = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_VendorBillLines_ItemOrDesc", "[ItemId] IS NOT NULL OR ([Description] IS NOT NULL AND LEN([Description]) > 0)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankTransactions_BankId_Date",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankTransactions_TransferTo",
                table: "BankTransactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChartOfAccounts_SubTypeId",
                table: "ChartOfAccounts",
                column: "SubTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ChartOfAccounts_TypeId",
                table: "ChartOfAccounts",
                column: "TypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_ScenarioId",
                table: "Customers",
                column: "ScenarioId");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_ScenarioTypeScenarioId",
                table: "Customers",
                column: "ScenarioTypeScenarioId");

            migrationBuilder.CreateIndex(
                name: "UX_Customers_BuyerId",
                table: "Customers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JournalEntries_CompanyId_Ref",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoices_CompanyId_Date",
                table: "SalesInvoices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoices_ScenarioId",
                table: "SalesInvoices",
                column: "ScenarioId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoices_ScenarioTypeScenarioId",
                table: "SalesInvoices",
                column: "ScenarioTypeScenarioId");

            migrationBuilder.CreateIndex(
                name: "UX_SalesInvoices_Number",
                table: "SalesInvoices",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_ScenarioTypes_Type",
                table: "ScenarioTypes",
                column: "ScenarioType",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UX_SubAccountTypes_Code",
                table: "SubAccountTypes",
                columns: new[] { "TypeId", "SubTypeCode" },
                unique: true);
