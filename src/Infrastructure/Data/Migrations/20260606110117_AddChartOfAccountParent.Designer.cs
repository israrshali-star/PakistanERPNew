...
namespace PakistanAccountingERP.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260606110117_AddChartOfAccountParent")]
    partial class AddChartOfAccountParent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PakistanAccountingERP.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<int>("ScenarioTypeScenarioId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ScenarioTypeScenarioId");
            ...
            modelBuilder.Entity("PakistanAccountingERP.Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasOne("PakistanAccountingERP.Domain.Entities.ScenarioType", "ScenarioType")
                        .WithMany("Customers")
                        .HasForeignKey("ScenarioTypeScenarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
