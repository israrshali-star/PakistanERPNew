...
namespace PakistanAccountingERP.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260913155737_AddSalesInvoiceShippingAddressUrdu")]
    partial class AddSalesInvoiceShippingAddressUrdu
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PakistanAccountingERP.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<string>("BuyerNameUrdu")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PakistanAccountingERP.Domain.Entities.CustomerReceiptAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_CustomerReceiptAttachments_CompanyId");

                    b.HasIndex("CustomerReceiptId")
                        .HasDatabaseName("IX_CustomerReceiptAttachments_CustomerReceiptId");

                    b.ToTable("CustomerReceiptAttachments", (string)null);
                });
            ...
            modelBuilder.Entity("PakistanAccountingERP.Domain.Entities.SalesInvoice", b =>
                {
                    ...
                    b.Property<DateTime?>("DeliveryChallanEmailedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("ShippingAddressUrdu")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("PakistanAccountingERP.Domain.Entities.Vendor", b =>
                {
                    ...
                    b.Property<string>("VendorNameUrdu")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PakistanAccountingERP.Domain.Entities.CustomerReceiptAttachment", b =>
                {
                    ...
                    b.HasOne("PakistanAccountingERP.Domain.Entities.CustomerReceipt", "CustomerReceipt")
